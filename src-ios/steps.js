   ...
   * 아이폰에만 있습니다. 고객 폰의 바코드·QR을 기사님 카메라로 읽습니다. */
  {
    ...
    steps: [
      ...
      },
      {
        ...
        note: '엘페이·카카오페이·알리페이·SSG·네이버페이를 받을 수 있어요',
        target: '#e-qr-code',
      },
      {
        screen: 'ecQr',
   ...
   * 분할 화면에 그대로 남습니다 (안드로이드는 배달지 화면으로 나갑니다). */
  {
    ...
    steps: [
      ...
      },
      {
        ...
        state: { order: 'cash', total: TOTAL },
        q: '이번에 받을 금액을 넣어요',
        a: '<b>20,000원</b>을 넣어주세요',
        note: '+1만원을 두 번 눌러도 되고, 숫자를 직접 눌러도 돼요',
        type: { expect: 20000 },
      },
      {
        screen: 'splitSheet',
      ...
      },
      {
        ...
        q: '남은 38,500원이 그대로 채워져 있어요',
        a: '<b>카드</b>를 눌러주세요',
        note: '58,500원이 아니라 남은 38,500원이 넘어가요',
        target: '#s-card',
      },
      {
        screen: 'easycheckShop',
